...
export default function ContactUS() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await addDoc(messagesRef, { ...data, createdAt: new Date() });
  ...
  return (
    <>
      ...
      <div className="min-h-screen font-hacen">
        <div className="bg-[#fafcfb] py-10 sm:py-14  px-4 text-center">
          <motion.h2
        ...
        <div
          ...
          className="relative bg-[#fafcfb] overflow-hidden"
        >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 pb-10 sm:pb-0">
            <div className="grid lg:grid-cols-5 gap-10 items-start">
              ...
              <motion.div
                ...
                className="lg:col-span-3 bg-white rounded-3xl shadow-xl p-8 md:p-10 order-2 lg:order-1"
              >
                <p
              ...
              >
                ...
                {/* Map */}
                <div className="rounded-2xl overflow-hidden shadow-sm border border-primary-light/20 min-h-[180px] sm:pb-10">
                  <iframe
                    title="location"
